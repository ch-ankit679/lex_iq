...
const Message = ({role,content}) => {
  ...
  return (
    <div className='flex flex-col items-center w-full max-w-3xl text-l'>
      <div className={`flex flex-col mb-8 w-full ${role === 'user' && 'items-end'}`}>
        <div className={`${role === 'user' ? 'bg-[#414158] px-5':'gap-3'} group relative flex max-w-2xl py-3 rounded-xl`}>
          ...
          </div>
          {
            ...
            (
              <>
              <Image src={assets.logo_icon} alt='' className='h-9 w-9 rounded-full'/>
